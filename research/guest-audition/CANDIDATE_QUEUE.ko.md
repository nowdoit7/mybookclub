...
| Round 1 순위 | 후보 | 실제 API 교차 결과 | 현재 상태 |
| --- | --- | --- | --- |
| 1 | 아이작 뉴턴 | 『불변의 법칙』 통과, 『삼체』 실패 | 논점 친화도에 민감합니다. 일반 독자보다 낫다고 예측될 때만 검토합니다. |
| 2 | 블레즈 파스칼 | 『불변의 법칙』 통과, 영문 『삼체』 언어 실패 | 품질상 선두지만 다국어 말투 지문을 고치기 전에는 진출할 수 없습니다. |
| 3 | 애덤 스미스 | 『불변의 법칙』 통과, 『삼체』 실패 | 자연스럽지만 강한 기준선보다 새 해석이 약했습니다. |
...
- **주 후보:** 아이작 뉴턴 — **실제 교차 테스트 완료; 런타임 미승인**
- **교체 범주:** 분석형
...
- **주 후보:** 블레즈 파스칼 — **실제 교차 테스트 완료; 다국어 설계 수정 필요**
- **교체 범주:** 분석형
...
- **주 후보:** 애덤 스미스 — **실제 교차 테스트 완료; 런타임 미승인**
- **교체 범주:** 맥락형

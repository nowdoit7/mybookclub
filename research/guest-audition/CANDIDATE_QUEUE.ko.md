...
| Round 1 순위 | 후보 | 현재 케이스 | 현재 케이스가 증명하는 범위 |
| --- | --- | --- | --- |
| 1 | 아이작 뉴턴 | `three-body-newton` | 과학소설 비교 1건이 있습니다. 책을 넘나드는 일반화는 아직 증명하지 못했습니다. |
| 2 | 블레즈 파스칼 | `same-as-ever-pascal` | 인접한 비즈니스/경제 비교 1건이 있습니다. 철학/종교 도서 2권 테스트는 아직 없습니다. |
| 3 | 애덤 스미스 | `same-as-ever-adam-smith` | 비즈니스/경제 비교 1건이 있습니다. 책을 넘나드는 일반화는 아직 증명하지 못했습니다. |

위 표에 없는 모든 후보의 상태는 **미검증**입니다. 어떤 후보든 런타임 검토
